...
<form:errors path="DELtocartproducts" />
			...
			<table>
				...
				<c:forEach var="selprd"
					items="${sessionScope.shoppnbag.entrySet() }">
					<tr>
						<td><form:checkbox path="DELtocartproducts"
								value="${selprd.getKey() }" /></td>
			...
			<br />
			<br />
			<a href="product">add more products</a>
			<br />
			<br />
